...
pub static mut woff2_kFLAG_ONCURVE: i32 = unsafe { 1 };
pub static mut woff2_kFLAG_XSHORT: i32 = unsafe { ((1) << (1)) };
pub static mut woff2_kFLAG_YSHORT: i32 = unsafe { ((1) << (2)) };
pub static mut woff2_kFLAG_REPEAT: i32 = unsafe { ((1) << (3)) };
pub static mut woff2_kFLAG_XREPEATSIGN: i32 = unsafe { ((1) << (4)) };
pub static mut woff2_kFLAG_YREPEATSIGN: i32 = unsafe { ((1) << (5)) };
pub static mut woff2_kFLAG_OVERLAP_SIMPLE: i32 = unsafe { ((1) << (6)) };
pub static mut woff2_kFLAG_ARG_1_AND_2_ARE_WORDS: i32 = unsafe { ((1) << (0)) };
pub static mut woff2_kFLAG_WE_HAVE_A_SCALE: i32 = unsafe { ((1) << (3)) };
pub static mut woff2_kFLAG_MORE_COMPONENTS: i32 = unsafe { ((1) << (5)) };
pub static mut woff2_kFLAG_WE_HAVE_AN_X_AND_Y_SCALE: i32 = unsafe { ((1) << (6)) };
pub static mut woff2_kFLAG_WE_HAVE_A_TWO_BY_TWO: i32 = unsafe { ((1) << (7)) };
pub static mut woff2_kFLAG_WE_HAVE_INSTRUCTIONS: i32 = unsafe { ((1) << (8)) };
...
pub static mut woff2_kWoff2HeaderSize: u64 = unsafe { 48_u64 };
pub static mut woff2_kWoff2EntrySize: u64 = unsafe { 20_u64 };
